...
__C.TEST.ANNOT_PATH             = "./data/tmp/tmp.txt"
...
# __C.TEST.WEIGHT_FILE            = "./checkpoint/yolov3_test_loss=2.5020.ckpt-43"
__C.TEST.WEIGHT_FILE            = "./checkpoint/yolov3_test_loss=7.9909.ckpt-41"
